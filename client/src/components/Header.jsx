  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        <div className='text-center mt-20 mb-8'>
            <div className='inline-flex items-center justify-ceter gap-4 px-6 py-1.5 mb-4 border
            border-primary/40 bg-primary/10 rounded-full text-sm text-primary'>
                <p>New: AI feature integrated</p>
                <img src={assets.star_icon} alt="" className='w-2.5'/>
            </div>

            <h1 className='text-3xl sm:text-6xl font-semibold sm:leading-[4rem] text-gray-700'><span 
            className='text-primary'>Blog</span> what's on your <br/> mind.</h1>
        ...
        <img src={assets.gradientBackground} alt="" className='absolute -top-12 -z-[1] opacity-50'/>
    </div>
  )
}
